...
const homepageBg = "https://wealthofgeeks.com/wp-content/uploads/2021/11/Top-50-Best-Anime-Cats-Most-Popular-of-All-the-Time.jpg"
const loadingScreenBg = "https://sm.ign.com/t/ign_ap/screenshot/default/haru-cute_chhs.1280.jpg";
...
if (gameContainer !== undefined) {
    gameContainer.style.backgroundImage=homepageBg ? `linear-gradient(to bottom, rgba(0, 0, 0, ${homepageBgDim}), rgba(0, 0, 0, ${homepageBgDim})), url(${homepageBg})` : "none";
    gameContainer.style.backgroundColor="#eee";
    gameContainer.style.backgroundSize="cover";
}

let mainBackground = document.getElementById("gameChatPage").getElementsByClassName('col-xs-9')[0];
...
function styleContainers() {
    ...
    document.getElementById("gcMessageContainer").style.backgroundColor="#1b1b1b";
    document.getElementById("qcStickOut").style.opacity="0.8";
}

function runOnPlayerJoin() {
    document.querySelectorAll(".lobbyAvatarNameContainer").forEach(container => {
